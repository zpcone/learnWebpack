...
console.log(`a: ${__WEBPACK_IMPORTED_MODULE_0__a__["a" /* default */].name}`)
console.log(`c1: ${__WEBPACK_IMPORTED_MODULE_1__c__["a" /* c1 */].name}; c2: ${__WEBPACK_IMPORTED_MODULE_1__c__["b" /* c2 */].name}`)
